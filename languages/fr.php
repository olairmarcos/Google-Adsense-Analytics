...
add_translation('fr', array(
    ...
    'advanced-google-tools:lblBanner728x90'   => 'ID Adslot pour la taille Bannière 728 X 90',
    'advanced-google-tools:lblBanner160x600'  => 'ID Adslot pour la taille Bannière 160 X 60',
